    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-12">
                <div class="card ">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Blog create</h3>
                        ...
                        @endif
                        <div class="w-100">
                            <form action="{!! route('admin.blogs.store') !!}" enctype="multipart/form-data"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="featured" value="true" name="featured">
                                    </div>
                                </div>
                                <div class="col-12">
