    ...
    <aside class="app-sidebar sidebar-scroll" style=" ">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="side-menu__label1"><a href="javascript:void(0);">Splash Pop Up</a>
                </li>
                <li class="sub-slide @if (Route::current()->getName() == 'admin.splash-pop-ups.create' || Route::current()->getName() == 'admin.splash-pop-ups.index') is-expanded @endif">
                    <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);">
                        <span class="sub-side-menu__label">Splash Pop Up<i class="sub-angle fe fe-chevron-down"></i>
                        </span></a>
                    <ul class="sub-slide-menu">

                        <li>
                            <a class="sub-side-menu__item @if (Route::current()->getName() == 'admin.splash-pop-ups.create') active @endif"
                                href="{!! route('admin.splash-pop-ups.create') !!}">Add a Splash Pop Up</a>
                        </li>

                        <li>
                            <a class="sub-side-menu__item @if (Route::current()->getName() == 'admin.splash-pop-ups.index') active @endif"
                                href="{!! route('admin.splash-pop-ups.index') !!}">Splash Pop Up List</a>
                        </li>
