...
<footer id="footer">
    ...
    <div class="footer-top" style="background-color: #7e8ea7; display: flex; align-items: center;">
        <div class="container-fluid px-5">
            <div class="row mt-5">
                ...
                <div class="col-md-1 footer-links">
                    ...
                    <ul>
                        <li class="d-block w-100">Leadership</li>
                        <li class="d-block w-100">Careers</li>
                        <li class="d-block w-100">News</li>
                    </ul>
                </div>
