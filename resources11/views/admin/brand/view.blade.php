                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" value="{{@$brand->name}}"
                                                   name="name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control summernote" value=""
                                                      name="why_choose">{{@$brand->why_choose}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="input-label">
                                                <label> In Dubai</label>
                                            </div>
                                            <textarea type="text" required class="form-control summernote" value=""
                                                      name="in_dubai">{{@$brand->in_dubai}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{@$brand->meta_title}}" name="meta_title">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   name="meta_description" value="{{@$brand->meta_description}}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   name="keywords" value="{{@$brand->keywords}}">
                                        </div>
                                    </div>
                                </div>
