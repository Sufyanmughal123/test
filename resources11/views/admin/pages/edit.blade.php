                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_1">{{@$page->section_1}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_2">{{@$page->section_2}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_3">{{@$page->section_3}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_4">{{@$page->section_4}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_5">{{@$page->section_5}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_6">{{@$page->section_6}}</textarea>
                                        </div>
                                    </div>
                                </div> <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_7">{{@$page->section_7}}</textarea>
                                        </div>
                                    </div>
                                </div><div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control summernote" value=""
                                                      name="section_8">{{@$page->section_8}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row mt-3">
