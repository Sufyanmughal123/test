                    ...
                    <div class="card-body">
                        ...
                        <div class="row    mt-4 mb-4 ">
                            <div class="col-12 text-right">
                                <a href="{!! route('admin.subscriber.index') !!}" class="btn btn-primary btn-sm ">
                                    Back </a>
                            </div>
                        </div>
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="w-100">
                            <form action="{!! route('admin.subscriber.update',$subcriber->id) !!}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" value="{!! $subcriber->email !!}" class="form-control">
                                        </div>
                                    </div>
                                </div>
