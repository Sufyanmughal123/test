...
<header id="header" class="fixed-top"
    style="background: linear-gradient(135deg, #F1F5FF, #3751A2, #566BAC, #44558A);height: 85px !important;

">
    <div class="headerTopBar col-xl-12 d-flex align-items-center"
        style="background: linear-gradient(135deg, #12192B, #354872, #12192B);font-size: 11px !important; padding: 0px !important;
">
            ...
            <div class="col-xl-12 d-flex align-items-center">
                <a href="/" class="logo mr-auto">
                    <img src="{{ asset($setting->site_logo ?? '/dist/image/newlogo1.jpeg') }}"
                        style="width: 45px;margin-top:5px; margin-left: 120px" alt="" class="img-fluid"></a>
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle">Our As-a-Service Platforms <i class=""
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="right-content">
                                    ...
                                    <div id="content1" class="content-item active">
                                        ...
                                        <p class="text-muted">Managed Detection and Response
                                        </p>
                        ...
                        <li class="drop-down desktop-show"><a href="#resources/">Resources <i class="fa fa-angle-down"
                                    aria-hidden="true"></i></a>
