...
@section('content')
    ...
    <main id="main " class="MDR_Page p-5  row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                     <a href="{!! route('service.details',$i->slug) !!}">   {!! $i->name !!} </a>
                    </div>
                    <div class="card-body">
                        {!! $i->short_descrition !!} <br/>
                        <a style=" " href="{!! route('service.details',$i->slug) !!}">Learn more--&gt;</a>
