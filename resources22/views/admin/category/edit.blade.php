    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-12">
                <div class="card ">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4">Category Update</h3>
                        ...
                        @endif
                        <div class="w-100">
                            <form action="{!! route('admin.categories.update', $category->id) !!}" enctype="multipart/form-data" id="form_validation"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control" name="description">{{$category->description}} </textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
