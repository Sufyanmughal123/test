    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-12">
                <div class="card ">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> City create</h3>
                        ...
                        @endif
                        <div class="w-100">
                            <form action="{!! route('admin.city.store') !!}" enctype="multipart/form-data"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="tile_image" required id="tile_image" class="form-control">
