        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{!! route('admin.dashboard') !!}" class="header-logo">
                    <img style="width: 60px;" src="{{ asset($setting->site_logo??'/dist/image/newlogo1.jpeg')   }}" class="logo-1" alt="logo">
                    <img style="width: 60px;"  src="{{ asset($setting->site_logo??'/dist/image/newlogo1.jpeg')   }}" class="dark-logo-1" alt="logo">
                </a>
            </div>
                    ...
                    <ul class="nav nav-item  navbar-nav-right ms-auto">
                                    ...
                                    <span class="input-group-btn">
														...
														<button type="submit" class="btn btn-default nav-link resp-btn">
															<svg xmlns="http://www.w3.org/2000/svg" height="24px"
                                                                 ...
                                                                 width="24px" fill="#000000"><path d="M0 0h24v24H0V0z"
                                                                                                   fill="none"/><path
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href=""><img alt=""
                                                                        src="{!! asset('admin/assets/img/users/6.jpg') !!}"></a>
                            <div class="dropdown-menu">
                                <div class="main-header-profile bg-primary p-3">
                                    <div class="d-flex wd-100p">
                                        <div class="main-img-user"><img alt=""
                                                                        src="{!! asset('admin/assets/img/users/6.jpg') !!}"
                                                                        class=""></div>
                                        <div class="ms-3 my-auto">
                                            <h6>{!! auth()->user()->name !!}</h6>
                                            <span>Yet not define</span>
                                        </div>
                                    </div>
                                </div>
