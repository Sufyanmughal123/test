...
<style>
    ...
    .footer-contact::after, .footer-links::after, .footer-newsletter::after {
        content: '';
        position: absolute;
    ...
    .footer-contact::after, .footer-links::after {
        bottom: -40px;
    }
...
<style>
    ...
    .item .cyber_tagline h1, .item .cyber_tagline h2 {
        font-size: 5vw;
        font-weight: 600;
        margin-bottom: 0.9vw;
        color: #fff;
    ...
    .item .cyber_tagline h1 span, .item .cyber_tagline h2 span {
        color: #f58220;
        font-size: 3.5vw;
    }
    .cyber_tagline {
    ...
    li.service_MDR p, li.service_MDR span {
        text-align: left;
    }
    ...
    .service_left_side h5 span, .service_soc h5 span, .service_MDR .service_left_side h5 span, .service_MFA .service_left_side h5 span,  .service_MDM .service_left_side h5 span,
    .service_DWM .service_left_side h5 span, .service_expertise_sec h5 span {
        color:#f58220;
    }
    ...
    .service_MFA .service_right_side, .service_MDM .service_right_side {
        position: relative;
        top: 6vw;
    }
    .service_DWM .service_left_side, .service_MDR .service_left_side, .service_email .service_left_side {
        width: 35%;
    }
    .service_DWM .service_right_side, .service_MDR .service_right_side {
        width: 65%;
        top: 3vw
    }
    ...
    .item .service_DFIR .service_left_side li span, .item .service_firewall .service_left_side li span {
        font-weight: 500;
        color: #f58220;
    }
    ...
    .service_soc ul li img, .service_expertise_sec ul li img, .service_SASE li img {
        position: relative;
        top: 0.4vw;
        right: 0.4vw;
    }
    ...
    @media screen and (max-width: 992px) {
        ...
        .service_soc ul li, .service_MDR ul li, .service_XDR ul li {
            font-size: 1.3vw;
            width: 30.5vw;
        }
